...
["", "binary.dart", , Z, {
  ...
  main: [function() {
    var t1, queries;
    P.Timer_Timer$periodic(C.Duration_1000000, Z.showClock$closure());
    t1 = window.location.search;
    t1.toString;
    queries = P.Uri_splitQueryString(H.stringReplaceFirstUnchecked(t1, "?", ""), C.Utf8Codec_false);
    if (queries.containsKey$1("clock") === true && J.compareTo$1$ns(J.$index$asx(queries, "clock"), "yes") === 0) {
      J.get$classes$x(document.querySelector(".clock")).remove$1(0, "hide");
      P.Timer_Timer$periodic(C.Duration_1000000, Z.runClock$closure());
    }
    if (queries.containsKey$1("bcd") === true && J.compareTo$1$ns(J.$index$asx(queries, "bcd"), "yes") === 0)
      J.get$classes$x(document.querySelector("#bcd")).remove$1(0, "hide");
  }, "call$0", "main$closure", 0, 0, 1],
  runClock: [function(t) {
    var now, formatter, time;
    ...
    formatter.addPattern$1("HH:mm:ss");
    time = formatter.format$1(0, now);
    document.querySelector(".clock").textContent = time;
  }, "call$1", "runClock$closure", 2, 0, 2],
  showClock: [function(t) {
    var now, formatter, digits, hour, t1, h, minute, m, second, s, digitsBCD, t2, i, digit, j;
    now = new P.DateTime(Date.now(), false);
    now.DateTime$_now$0();
    formatter = new T.DateFormat(null, null, null);
    formatter._locale = T.Intl_verifiedLocale(null, T.DateFormat_localeExists$closure(), T.Intl__throwLocaleError$closure());
    formatter.addPattern$1("HH:mm:ss");
    digits = formatter.format$1(0, now).split(":");
    if (0 >= digits.length)
      return H.ioore(digits, 0);
    hour = H.Primitives_parseInt(digits[0], null, null);
    t1 = J.getInterceptor$n(hour);
    h = [J.toString$0(t1.$tdiv(hour, 10)), J.toString$0(t1.$sub(hour, J.$mul$ns(t1.$tdiv(hour, 10), 10)))];
    if (1 >= digits.length)
      return H.ioore(digits, 1);
    minute = H.Primitives_parseInt(digits[1], null, null);
    t1 = J.getInterceptor$n(minute);
    m = [J.toString$0(t1.$tdiv(minute, 10)), J.toString$0(t1.$sub(minute, J.$mul$ns(t1.$tdiv(minute, 10), 10)))];
    if (2 >= digits.length)
      return H.ioore(digits, 2);
    second = H.Primitives_parseInt(digits[2], null, null);
    t1 = J.getInterceptor$n(second);
    s = [J.toString$0(t1.$tdiv(second, 10)), J.toString$0(t1.$sub(second, J.$mul$ns(t1.$tdiv(second, 10), 10)))];
    digitsBCD = [];
    digitsBCD.push(Z.digitToBCD(H.Primitives_parseInt(h[0], null, null)));
    digitsBCD.push(Z.digitToBCD(H.Primitives_parseInt(h[1], null, null)));
    digitsBCD.push(Z.digitToBCD(H.Primitives_parseInt(m[0], null, null)));
    digitsBCD.push(Z.digitToBCD(H.Primitives_parseInt(m[1], null, null)));
    digitsBCD.push(Z.digitToBCD(H.Primitives_parseInt(s[0], null, null)));
    digitsBCD.push(Z.digitToBCD(H.Primitives_parseInt(s[1], null, null)));
    t1 = document.querySelector("#bcd");
    if (0 >= digitsBCD.length)
      return H.ioore(digitsBCD, 0);
    t2 = digitsBCD[0];
    if (typeof t2 !== "string")
      return t2.$add();
    t2 += " ";
    if (1 >= digitsBCD.length)
      return H.ioore(digitsBCD, 1);
    t2 = C.JSString_methods.$add(t2, digitsBCD[1]) + " : ";
    if (2 >= digitsBCD.length)
      return H.ioore(digitsBCD, 2);
    t2 = C.JSString_methods.$add(t2, digitsBCD[2]) + " ";
    if (3 >= digitsBCD.length)
      return H.ioore(digitsBCD, 3);
    t2 = C.JSString_methods.$add(t2, digitsBCD[3]) + " : ";
    if (4 >= digitsBCD.length)
      return H.ioore(digitsBCD, 4);
    t2 = C.JSString_methods.$add(t2, digitsBCD[4]) + " ";
    if (5 >= digitsBCD.length)
      return H.ioore(digitsBCD, 5);
    t1.textContent = C.JSString_methods.$add(t2, digitsBCD[5]);
    for (i = 0; i < digitsBCD.length; ++i) {
      digit = digitsBCD[i].split("");
      for (j = 0; j < digit.length; ++j) {
        if (J.compareTo$1$ns(digit[j], "0") === 0) {
          t1 = "#dot" + C.JSInt_methods.toString$0(j) + C.JSInt_methods.toString$0(i);
          J.get$classes$x(document.querySelector(t1)).remove$1(0, "light");
          t1 = "#dot" + C.JSInt_methods.toString$0(j) + C.JSInt_methods.toString$0(i);
          J.get$classes$x(document.querySelector(t1)).add$1(0, "dark");
        }
        if (j >= digit.length)
          return H.ioore(digit, j);
        if (J.compareTo$1$ns(digit[j], "1") === 0) {
          t1 = "#dot" + C.JSInt_methods.toString$0(j) + C.JSInt_methods.toString$0(i);
          J.get$classes$x(document.querySelector(t1)).remove$1(0, "dark");
          t1 = "#dot" + C.JSInt_methods.toString$0(j) + C.JSInt_methods.toString$0(i);
          J.get$classes$x(document.querySelector(t1)).add$1(0, "light");
        }
      }
    }
  }, "call$1", "showClock$closure", 2, 0, 2],
  digitToBCD: function(digit) {
    var num;
    switch (digit) {
      case 0:
        num = "0000";
...
["dart.convert", "dart:convert", , P, {
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:20;box_0,this_1,codeUnits_2",
...
["intl", "package:intl/intl.dart", , T, {
  ...
  DateFormat: {
    "^": "Object;_locale,_pattern,_formatFieldsPrivate",
    format$1: function(_, date) {
      ...
      if (t1 == null) {
        ...
        t1 = this.parsePattern$1(this._pattern);
    ...
    _appendPattern$2: function(inputPattern, separator) {
      ...
      this._pattern = t1 == null ? inputPattern : H.S(t1) + separator + H.S(inputPattern);
    },
...
//# sourceMappingURL=binary.dart.js.map
//@ sourceMappingURL=binary.dart.js.map
